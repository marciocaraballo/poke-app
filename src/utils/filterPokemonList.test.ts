...
describe('filterPokemonList()', () => {
    ...
    it('should return empty pokemonList if name filter doesnt match', () => {
        ...
        const pokemonList = [{ name: 'abra', url: 'url/abra' }, { name: 'mew', url: 'url/mew' }, { name: 'mewtwo', url: 'url/mewtwo' }];
    ...
    it('should return pokemonList if name filter matches', () => {
        ...
        expect(result).toEqual([{ name: 'mew', url: 'url/mew' }, { name: 'mewtwo', url: 'url/mewtwo' }]);
    });

    it('should return empty pokemonList if ID filter doesnt match', () => {

        const pokemonList = [{ name: 'abra', url: 'https://pokeapi.co/api/v2/pokemon/2/' }];
    ...
    it('should return empty pokemonList if ID filter matches', () => {
        ...
        expect(result).toEqual([{ name: 'abra', url: 'https://pokeapi.co/api/v2/pokemon/2/' }]);
    });
});